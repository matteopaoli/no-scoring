...
import { Tooltip, IconButton, Popover, PopoverTrigger, PopoverContent, PopoverArrow, PopoverCloseButton, PopoverHeader, PopoverBody, PopoverFooter, Button } from '@chakra-ui/react';
      ...
      <Popover isOpen={isPopoverOpen} onClose={() => setPopoverOpen(false)}>
        ...
        <PopoverContent>
          ...
          <PopoverFooter display="flex" justifyContent="flex-end">
            <Button variant="outline" mr={3} onClick={() => setPopoverOpen(false)}>
              Annulla
            </Button>
