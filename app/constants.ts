...
export const STRIPE_COMMISSION_VAR = .0499
export const STRIPE_COMMISSION_FIXED = 0.4
...
export const provinces = [
    ...
    "Messina", "Milano", "Modena", "Monza e Brianza", "Napoli", "Novara", "Nuoro",
    ...
    "Sud Sardegna", "Taranto", "Teramo", "Terni", "Torino", "Trapani", "Trento",
